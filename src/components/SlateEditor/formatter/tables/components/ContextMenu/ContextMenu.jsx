...
export const ContextMenu= ({
  ...
  return ReactDOM.createPortal(
    <div
      ref={menuRef}
      className={styles["yt-e-table-context-menu"]}
      style={{
    ...
    >
      ...
      <span className={styles["yt-e-split-line"]} />
      <div
        onMouseDown={(e) => {
          e.preventDefault()
          run(deleteRow)
      ...
      <span className={styles["yt-e-split-line"]} />
      <div
        className={selectCells.length > 1 ? '' : styles['yt-e-disabled']}
        onMouseDown={(e) => {
          e.preventDefault()
      ...
      <div
        className={isMergeCell() ? '' : styles['yt-e-disabled']}
        onMouseDown={(e) => {
          e.preventDefault()
